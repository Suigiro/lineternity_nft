...
/**
 * @author Anarchy This class should manage the creation and scheduling of the
 *         events, as well as hold information of the participants.
 */
public final class EventManager {
	...
	public void registerPlayer(Player player) {
		...
		if (player.getClassId() == ClassId.BISHOP || player.getClassId() == ClassId.CARDINAL
				|| player.getClassId() == ClassId.SHILLIEN_ELDER || player.getClassId() == ClassId.SHILLIEN_SAINT
				|| player.getClassId() == ClassId.ELVEN_ELDER || player.getClassId() == ClassId.EVAS_SAINT
				|| player.getClassId() == ClassId.PROPHET || player.getClassId() == ClassId.HIEROPHANT) {
