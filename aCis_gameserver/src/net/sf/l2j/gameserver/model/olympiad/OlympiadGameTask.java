...
public final class OlympiadGameTask implements Runnable {
	...
	public static final int[] BATTLE_START_TIME = { 60, 50, 40, 30, 20, 10, 5, 4, 3, 2, 1, 0 };
	...
	private static enum GameState {
		BEGIN, TELE_TO_ARENA, GAME_STARTED, BATTLE_COUNTDOWN, BATTLE_STARTED, BATTLE_IN_PROGRESS, GAME_STOPPED,
		TELE_TO_TOWN, CLEANUP, IDLE
	}
	...
	public final void run() {
		try {
			...
			case BATTLE_COUNTDOWN: {
				_zone.broadcastPacket(SystemMessage.getSystemMessage(SystemMessageId.THE_GAME_WILL_START_IN_S1_SECOND_S)
						.addNumber(_countDown));
