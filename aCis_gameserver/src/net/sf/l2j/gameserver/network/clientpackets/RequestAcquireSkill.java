...
public class RequestAcquireSkill extends L2GameClientPacket {
	...
	protected void runImpl() {
		int skillLvl, spCost, spbId, costId, costCount, itemId, repCost;
		...
		case 2:
			...
			player.sendPacket(
					SystemMessage.getSystemMessage(SystemMessageId.S1_DEDUCTED_FROM_CLAN_REP).addNumber(csn.getCost()));
