...
public final class SystemMessageId {
	...
	/**
	 * ID: 68<br>
	 * Message: Would you like to withdraw from the $s1 clan? If you leave, you will
	 * have to wait at least a day before joining another clan.
	 */
	...
	/**
	 * ID: 78<br>
	 * Message: When you delete a character, any items in his/her possession will
	 * also be deleted. Do you really wish to delete $s1%?
	 */
	...
	/**
	 * ID: 135<br>
	 * Message: $s1 did not reply to your invitation. Your invitation has been
	 * cancelled.
	 */
	...
	/**
	 * ID: 232<br>
	 * Message: After leaving or having been dismissed from a clan, you must wait at
	 * least a day before joining another clan.
	 */
	public static final SystemMessageId YOU_MUST_WAIT_BEFORE_JOINING_ANOTHER_CLAN;

	/**
	 * ID: 233<br>
	 * Message: The Academy/Royal Guard/Order of Knights is full and cannot accept
	...
	/**
	 * ID: 250<br>
	 * Message: You have personally surrendered to the $s1 clan. You are no longer
	 * participating in this clan war.
	 */
	...
	/**
	 * ID: 572<br>
	 * Message: Do you accept $s1's party invitation? (Item Distribution: Finders
	 * Keepers.)
	 */
	...
	/**
	 * ID: 590<br>
	 * Message: Your pet is motionless and any attempt you make to give it something
	 * goes unrecognized.
	 */
	...
	/**
	 * ID: 702 <br>
	 * Message: There are no GMs currently visible in the public list as they may be
	...
	/**
	 * ID: 720<br>
	 * Message: The purchase price is higher than the amount of money that you have
	 * and so you cannot open a personal store.
	 */
	 ...
	 * maximum that you can submit in one day. You cannot submit any more petitions.
	 */
	...
	/**
	 * ID: 735<br>
	 * Message: You have failed at submitting a petition on behalf of $s1. The error
	 * number is $s2.
	 */
	...
	/**
	 * ID: 739<br>
	 * Message: You have failed at cancelling a petition on behalf of $s1. The error
	 * number is $s2.
	 */
	...
	/**
	 * ID: 742<br>
	 * Message: You have failed at adding $s1 to the petition chat. The error code
	 * is $s2.
	 */
	...
	/**
	 * ID: 744<br>
	 * Message: You have failed at removing $s1 from the petition chat. The error
	 * code is $s2.
	 */
	...
	/**
	 * ID: 761<br>
	 * Message: $s1 clan cannot join the alliance because one day has not yet passed
	 * since it left another alliance.
	 */
	 ...
	 * clan leader. Do you want to continue?
	 */
	 ...
	 * chat ban will be applied. This is done to discourage spamming. Please avoid
	 * posting the same message multiple times during a short period.
	 */
	...
	/**
	 * ID: 1113<br>
	 * Message: The prize amount for Lucky Lottery #$s1 is $s2 adena. There was no
	 * first prize winner in this drawing, therefore the jackpot will be added to
	 * the next drawing.
	 */
	 ...
	 * and volume are less than 80 percent of capacity.
	 */
	 ...
	 * accounts of your quest while your inventory exceeded 80 percent of capacity.
	 */
	 ...
	 * illegally, this account is not allowed to connect to the game server for $s1
	 * minutes. Please use another game server.
	 */
	 ...
	 * the Support Center on the PlayNC website(http://www.plaync.com/us/support/)
	 */
	...
	/**
	 * ID: 1211<br>
	 * Message: Seven Signs: The quest event period has ended. The next quest event
	 ...
	 * war, your Exp will drop the same as if you were to die once.
	 */
	 ...
	 * ID: 1253<br>
	 * Message: Are you sure you want to surrender? Exp penalty will be the same as
	 * death and you will not be allowed to participate in clan war.
	 */
	...
	/**
	 * ID: 1261<br>
	 * Message: Seven Signs: The quest event period has begun. Speak with a Priest
	 * of Dawn or Dusk Priestess if you wish to participate in the event.
	 */
	 ...
	 * you are a member of the Lords of Dawn.
	 */
	 ...
	 * ID: 1271<br>
	 * Message: Do you wish to participate? Until the next seal validation period,
	 * you are a member of the Revolutionaries of Dusk.
	 */
	 ...
	 * for in-game MSN Messenger Chat. Add/Delete Contacts and other MSN Messenger
	 ...
	 * well. The contact can still check your online status and well not be blocked
	 ...
	 * .NET Messenger Service on this computer.
	 */
	 ...
	 * exists in your Linage 2 directory.
	 */
	 ...
	 * and a restriction has been imposed upon you. You may not move for $s1
	 * minutes.
	 */
	 ...
	 * joined a party or who is currently the leader of a party.
	 */
	 ...
	 * for creating this item. Please check the new price before trying again.
	 */
	 ...
	 * purchased from a village store. However, you can still sell them to any
	 * village store.
	 */
	...
	/**
	 * ID: 1472<br>
	 * Message: You look oddly at the fishing pole in disbelief and realize that you
	 * can't attack anything with this.
	 */
	...
	/**
	 * ID: 1481<br>
	 * Message: You have selected a class irrelevant individual match. Do you wish
	 * to participate?
	 */
	...
	/**
	 * ID: 1494<br>
	 * Message: Your opponent does not meet the requirements to do battle, the match
	 * has been cancelled.
	 */
	...
	/**
	 * ID: 1510<br>
	 * Message: $s1 is making an attempt at resurrection. Do you want to continue
	 ...
	 * minutes or your pet and all of it's items will disappear forever!
	 */
	...
	/**
	 * ID: 1562<br>
	 * Message: A Clan War has been declared against the clan, $s1. you will only
	 ...
	 * than level three, and or they do not have enough members.
	 */
	public static final SystemMessageId S1_CLAN_CANNOT_DECLARE_WAR_TOO_LOW_LEVEL_OR_NOT_ENOUGH_MEMBERS;

	/**
	 * ID: 1564<br>
	 * Message: A Clan War can be declared only if the clan is level three or above,
	 * and the number of clan members is fifteen or greater.
	 */
	...
	/**
	 * ID: 1662<br>
	 * Message: The fish are no longer biting here because you've caught too many!
	 * Try fishing in another location.
	 */
	 ...
	 * win(s) and $s3 defeat(s). You have earned $s4 Olympiad Point(s).
	 */
	 ...
	 * you! Reduce your weight to below 80 percent full and request to join again!
	 */
	...
	/**
	 * ID: 1692<br>
	 * Message: You have changed from your main class to a subclass and therefore
	 * are removed from the Grand Olympiad Games waiting list.
	 */
	...
	/**
	 * ID: 1773<br>
	 * Message: Since your clan emerged victorious from the siege, $s1 points have
	...
	/**
	 * ID: 1774<br>
	 * Message: Your clan's newly acquired contested clan hall has added $s1 points
	 * to your clan's reputation score.
	 */
	public static final SystemMessageId CLAN_ACQUIRED_CONTESTED_CLAN_HALL_AND_S1_REPUTATION_POINTS;

	/**
	 * ID: 1775<br>
	 * Message: Clan member $s1 was an active member of the highest-ranked party in
	 * the Festival of Darkness. $s2 points have been added to your clan's
	 * reputation score.
	 */
	 ...
	 * points have been deducted from your clan's reputation score.
	 */
	 ...
	 * from your clan's reputation score.
	 */
	...
	/**
	 * ID: 1789<br>
	 * Message: Since the Clan Reputation Score has dropped to 0 or lower, your clan
	 * skill(s) will be de-activated.
	 */
	 ...
	 * time(s). You will be allowed to make more attempt(s).
	 */
	 ...
	 * time(s). Please try again in 4 hours.
	 */
	 ...
	 * the game for some time. You may reactivate your account by visiting the
	 ...
	 * All crops have been returned and no adena withdrawn.
	 */
	...
	/**
	 * ID: 2020<br>
	 * Message: $s1 cannot make a challenge to a duel because $s1 is currently in a
	 ...
	 * Message: $s1 wishes to summon you from $s2. Do you accept?
	 */
	public static final SystemMessageId S1_WISHES_TO_SUMMON_YOU_FROM_S2_DO_YOU_ACCEPT_EVENT;
	...
	static {
		...
		BECAUSE_YOUR_CLAN_IS_NOT_CURRENTLY_ON_THE_OFFENSIVE_IN_A_CLAN_HALL_SIEGE_WAR_IT_CANNOT_SUMMON_ITS_BASE_CAMP = new SystemMessageId(
				294);
		...
		PAYMENT_FOR_YOUR_CLAN_HALL_HAS_NOT_BEEN_MADE_PLEASE_MAKE_PAYMENT_TO_YOUR_CLAN_WAREHOUSE_BY_S1_TOMORROW = new SystemMessageId(
				1051);
		THE_CLAN_HALL_FEE_IS_ONE_WEEK_OVERDUE_THEREFORE_THE_CLAN_HALL_OWNERSHIP_HAS_BEEN_REVOKED = new SystemMessageId(
				1052);
		...
		PLEASE_SELECT_THE_PERSON_TO_WHOM_YOU_WOULD_LIKE_TO_TRANSFER_THE_RIGHTS_OF_A_PARTY_LEADER = new SystemMessageId(
				1400);
		...
		THE_GAME_HAS_BEEN_CANCELLED_BECAUSE_THE_OTHER_PARTY_DOES_NOT_MEET_THE_REQUIREMENTS_FOR_JOINING_THE_GAME = new SystemMessageId(
				1494);
		...
		THE_CURRENT_RECORD_FOR_THIS_OLYMPIAD_SESSION_IS_S1_MATCHES_S2_WINS_S3_DEFEATS_YOU_HAVE_EARNED_S4_OLYMPIAD_POINTS = new SystemMessageId(
				1673);
		...
		YOU_ARE_UNABLE_TO_EQUIP_THIS_ITEM_WHEN_YOUR_PK_COUNT_IS_GREATER_THAN_OR_EQUAL_TO_ONE = new SystemMessageId(
				1685);
		...
		YOU_ARE_ALREADY_ON_THE_WAITING_LIST_FOR_ALL_CLASSES_WAITING_TO_PARTICIPATE_IN_THE_GAME = new SystemMessageId(
				1690);
		SINCE_80_PERCENT_OR_MORE_OF_YOUR_INVENTORY_SLOTS_ARE_FULL_YOU_CANNOT_PARTICIPATE_IN_THE_OLYMPIAD = new SystemMessageId(
				1691);
		SINCE_YOU_HAVE_CHANGED_YOUR_CLASS_INTO_A_SUB_JOB_YOU_CANNOT_PARTICIPATE_IN_THE_OLYMPIAD = new SystemMessageId(
				1692);
		...
		CLAN_MEMBER_S1_WAS_IN_HIGHEST_RANKED_PARTY_IN_FESTIVAL_OF_DARKNESS_AND_GAINED_S2_REPUTATION = new SystemMessageId(
				1775);
		...
		S1_HAS_ACCEPTED_YOUR_CHALLENGE_TO_DUEL_AGAINST_THEIR_PARTY_THE_DUEL_WILL_BEGIN_IN_A_FEW_MOMENTS = new SystemMessageId(
				1934);
		...
		SINCE_THE_PERSON_YOU_CHALLENGED_IS_NOT_CURRENTLY_IN_A_PARTY_THEY_CANNOT_DUEL_AGAINST_YOUR_PARTY = new SystemMessageId(
				1937);
		...
		S1_CANNOT_MAKE_A_CHALLANGE_TO_A_DUEL_BECAUSE_S1_IS_CURRENTLY_IN_A_DUEL_PROHIBITED_AREA = new SystemMessageId(
				2020);
